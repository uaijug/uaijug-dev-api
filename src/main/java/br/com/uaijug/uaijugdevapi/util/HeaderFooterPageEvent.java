...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
    ...
    private void addHeader(PdfWriter writer){
        ...
        try {
            ...
            // add image
            Image logo = Image.getInstance(HeaderFooterPageEvent.class.getResource("/static/img/uaijug.jpeg"));
           // String path = ClassLoader.getSystemResource("uaijug.jpg").getPath();
